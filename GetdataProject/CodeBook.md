...
This text was extracted from the README file of hte UCI HAR Dataset repository:
...
This dataset mantains the variable names of the previous dataset, and adds the variable names of Activity and Subject.
